 ...
 ****************************************************/
 // Haphazard experiment, derived from above. Sorry, documentation
...
#define MPR121_I2CADDR_DEFAULT 0xe0 // from the configurator

//None of this is going to apply for new chip
